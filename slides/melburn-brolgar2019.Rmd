...
date: "<span style = 'font-size: 90%;'>MelBURN <br><br> Monday 7th October, 2019 </span><br><br> `r icon::fa('link')` [bit.ly/melb-njt](https://bit.ly/melb-njt)<br><br>`r icon::fa('twitter')` [nj_tierney](https://twitter.com/nj_tierney)"
output:
...
layout: true
<div class="my-footer"><span>bit.ly/melb-njt • @nj_tierney</span></div> 
...
heights_dec <- heights %>%
  ...
  filter(range_diff == max(range_diff)) %>%
...
## features: similar to summarise but **aware of data structure** <img src="https://feasts.tidyverts.org/reference/figures/logo.png" align="right" height=140/>
...
`r icon::fa('link')` [bit.ly/melb-njt](https://bit.ly/melb-njt)
